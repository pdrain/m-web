package cn.meilituibian.web.servlet;
...
public class CaptchaGenServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            session.setAttribute(Constants.CAPTCHA_CODE, captchaStr);
    ...
    private String generateCaptchaText(int captchaLength) {
        String saltChars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890";
        StringBuilder sb = new StringBuilder();
        Random random = new Random();
        while (sb.length() < captchaLength) {
